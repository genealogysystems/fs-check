...
module.exports = function(child, mother, father, childRelationship) {
  ...
  if(!mother) {
    ...
    var descr = utils.markdown(function(){/*
      ...
      When you find the mother, add her to the tree and add her as the mother in [the child and parents relationship](https://familysearch.org/tree/#view=parentChildRelationship&relationshipId={{crid}}).
