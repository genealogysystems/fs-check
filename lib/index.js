...
var checks = [
  ...
  require('./checks/missingBirthFormalDate.js'),
  require('./checks/missingBirthFormalPlace.js'),
  ...
  require('./checks/missingDeathFormalDate.js'),
  require('./checks/missingDeathFormalPlace.js'),
  ...
  require('./checks/missingMarriageFormalDate.js'),
  require('./checks/missingMarriageNormalizedPlace.js'),
